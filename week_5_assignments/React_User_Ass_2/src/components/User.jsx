function User(props){
    ...
    return(
        <div className='shadow-2xl p-10 rounded-4xl bg-linear-to-br from-yellow-300 via-white to-purple-200 hover:shadow-3xl hover:-translate-y-2 hover:scale-105 cursor-pointer'>
